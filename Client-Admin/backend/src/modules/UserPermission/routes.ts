...
import UserPermissionController from "./contrller.js";
 ...
 */
router.get("/:id", PermissionMiddleware("user_permission.index"), UserPermissionController.index);
 ...
 *         description: کاربر پیدا نشد
 */
router.put("/:id", PermissionMiddleware("user_permission.assign"), UserPermissionController.assign);
