...
import type { MinIOClientOptions } from "./minIoService.js";
...
class ManagerService {
    ...
    private async refreshToken(): Promise<string> {
        ...
        const response = await fetch(`${this.baseUrl}/service/token`, {
            method: "POST",
    ...
    async getTenantByDomain(domain: string): Promise<TenantData> {
        ...
        const url = new URL(`${this.baseUrl}/service/tenants`);
