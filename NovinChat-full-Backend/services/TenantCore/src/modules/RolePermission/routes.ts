 ...
 */
router.get("/:id", PermissionMiddleware("role_permission.index"), RolePermissionController.index);
 ...
 *         description: نقش پیدا نشد
 */
router.put("/:id", PermissionMiddleware("role_permission.assign"), RolePermissionController.assign);
