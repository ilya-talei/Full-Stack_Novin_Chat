 ...
 */
router.get("/", PermissionMiddleware("user.view"), UserController.index);
...
router.put(
    "/change-password",
    PermissionMiddleware("user.change_password"),
 ...
 */
router.get("/:id", PermissionMiddleware("user.view"), UserController.show);
 ...
 */
router.post("/", PermissionMiddleware("user.create"), UserController.create);
 ...
 *         description: کاربر پیدا نشد
 */
router.put("/:id", PermissionMiddleware("user.update"), UserController.update);
