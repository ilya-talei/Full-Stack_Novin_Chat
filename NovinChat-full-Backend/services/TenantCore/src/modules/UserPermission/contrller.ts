...
class UserPermissionController {
    index = async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            const permissions = await req.tenant!.services.userPermission.index(userId);
    ...
    assign = async (req: Request, res: Response, next: NextFunction) => {
        try {
            const userId: number = getValidatedIdParam(req);
            ...
            await req.tenant!.services.userPermission.assign(userId, permission_name, allow);
    ...
    remove = async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            await req.tenant!.services.userPermission.remove(userId, permission_name);
